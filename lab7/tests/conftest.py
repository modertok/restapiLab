...
# ── Patch DB engine before importing main ─────────────────────────────────────
import database
...
# ── Patch Redis client before importing main ──────────────────────────────────
...
app.dependency_overrides[get_db] = lambda: _TestSession().__aiter__().__anext__()
...
# ── Expose fake_redis as a fixture for rate-limiter tests ─────────────────────
